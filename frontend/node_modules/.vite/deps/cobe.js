//#region node_modules/cobe/dist/index.esm.js
function Re(e, t, r) {
...
var Pe = (e, t) => {
	...
	let f = t.phi || 0, l = t.theta || 0, c = t.markers || [], s = t.arcs || [], A = t.mapSamples || 1e4, v = t.mapBrightness || 1, d = t.mapBaseBrightness || 0, g = t.baseColor || [
		...
		.6,
		1
	], E = t.arcWidth ?? 1, R = t.arcHeight ?? .2, b = t.diffuse || 1, x = t.dark || 0, y = t.opacity ?? 1, T = t.offset || [0, 0], B = t.scale || 1, p = t.markerElevation ?? .05, w = Y(a, Be, Ce), C = Y(a, be, ge), F = Y(a, Fe, Le);
	if (!w) return {
		destroy: () => {},
		update: () => {}
	};
