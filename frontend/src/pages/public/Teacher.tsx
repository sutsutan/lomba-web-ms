                        ...
                        {teacherData.leadership.map((leader, index) => (
                            <ScrollReveal key={index} delay={index * 0.2}>
                                <div className="flex flex-col md:flex-row gap-8 bg-white p-8 rounded-[3rem] shadow-xl border border-gray-100 items-center group hover:border-[#0F5F58]/20 transition-all">
                                    <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden flex-shrink-0 border-8 border-[#B8C5D0]/30 shadow-inner bg-slate-100 flex items-center justify-center">
                                        {leader.image ? (
                                            <img
                                                src={leader.image}
                                                alt={leader.name}
                    ...
                    <div className="min-h-[400px]">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                        ...
                                        <div className="relative h-80 overflow-hidden bg-slate-100">
                                            {teacher.image ? (
                                                <img
                                                    ...
                                                    onError={(e) => { e.currentTarget.src = 'https://placehold.co/300x400/e2e8f0/94a3b8?text=Guru'; }}
                                                />
                                            ) : (
                                ...
                                {(!teacherData.departments[activeDept as keyof typeof teacherData.departments] || 
                                  teacherData.departments[activeDept as keyof typeof teacherData.departments].length === 0) && (
                                    <div className="col-span-full py-16 text-center text-slate-400 font-medium">
                                        Belum ada data guru di divisi ini.
                                    </div>
                                )}
                            </motion.div>
                        </AnimatePresence>
