    ...
    <MainLayout>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          {loading ? (
            <div className="text-center py-20 text-muted-foreground font-medium">Sinkronisasi arsip berita sekolah...</div>
          ) : (
            <>
              {allNewsData.length === 0 ? (
                <div className="text-center py-20 text-muted-foreground">Belum ada berita yang diterbitkan.</div>
              ) : (
                      ...
                      <article className="group card-hover bg-card rounded-2xl overflow-hidden border border-border flex flex-col h-full shadow-sm">
                        ...
                        <div className="p-6 flex flex-col flex-1">
                          <div className="flex items-center gap-2 text-muted-foreground text-xs mb-3">
                            ...
                            {new Date(news.published_date).toLocaleDateString(language === 'id' ? 'id-ID' : 'en-US', { 
