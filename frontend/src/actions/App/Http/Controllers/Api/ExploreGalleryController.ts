...
/**
* @see \App\Http\Controllers\Api\ExploreGalleryController::index
 * @see app/Http/Controllers/Api/ExploreGalleryController.php:18
 * @route '/api/explore-galleries'
 */
...
const ExploreGalleryController = { index, store, update, destroy }

export default ExploreGalleryController