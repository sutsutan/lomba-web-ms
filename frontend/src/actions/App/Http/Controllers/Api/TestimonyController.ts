...
/**
* @see \App\Http\Controllers\Api\TestimonyController::index
 * @see app/Http/Controllers/Api/TestimonyController.php:12
...
const TestimonyController = { index, store, update, destroy }
