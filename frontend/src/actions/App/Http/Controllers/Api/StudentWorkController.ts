...
/**
* @see \App\Http\Controllers\Api\StudentWorkController::index
 * @see app/Http/Controllers/Api/StudentWorkController.php:22
 * @route '/api/student-works'
 */
...
const StudentWorkController = { index, store, update, destroy }
