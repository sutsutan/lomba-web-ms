...
/**
* @see \App\Http\Controllers\Api\ActivityGalleryController::index
 * @see app/Http/Controllers/Api/ActivityGalleryController.php:20
 * @route '/api/activity-galleries'
 */
...
const ActivityGalleryController = { index, store, update, destroy }

export default ActivityGalleryController