                                    ...
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <h3 className="text-4xl font-black uppercase tracking-tighter text-[#12606A]">
                                                {t('major.career.title')}
                                            </h3>
                                            <p className="font-medium text-[#12606A]/60">
                                                {t('major.career.subtitle')}
                                            </p>
                                        </div>
                                    </div>
