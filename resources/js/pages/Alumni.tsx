    ...
    return (
        <MainLayout>
            <HeroCarousel
                ...
                description="Connecting thousands of Metland graduates who are shaping the future across industries worldwide."
                height="h-[60vh] md:h-[70vh]" // Responsif height carousel
            />
                        ...
                        <ScrollReveal>
                            <div className="mb-8 md:mb-12 text-center">
                                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#12606A]/10 px-4 py-1.5 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-[#12606A]">
                                    <Target size={14} /> Global Footprint
                                </div>
                                <h2 className="text-3xl font-black tracking-tight text-[#12606A] md:text-6xl">
                                    World Class <span className="text-teal-500">Talents</span>
                                </h2>
                                <p className="mt-4 md:mt-6 max-w-2xl text-sm md:text-lg text-slate-500">
                                    Our graduates are making their mark in global tech hubs and creative capitals. 
                                    <span className="hidden md:inline"> Click an alumni card below to view their journey.</span>
                                </p>
                            </div>
                        </ScrollReveal>

                        {/* Globe Display Container - Responsive Rounded & Padding */}
                        <div className="relative w-full max-w-5xl rounded-[2.5rem] md:rounded-[4rem] border border-white/40 bg-white/30 p-2 md:p-8 shadow-2xl backdrop-blur-md">
                            <div className="relative overflow-hidden rounded-[2.2rem] md:rounded-[3.5rem] bg-[#12606A] shadow-2xl">
                                ...
                                <div className="absolute bottom-6 right-8 z-20 hidden flex-col items-end gap-1 opacity-60 md:flex">
                                    <p className="text-[9px] font-black uppercase tracking-[0.3em] text-white">Interactive Sphere</p>
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 md:mb-20 flex flex-col items-center justify-between gap-6 border-b border-slate-100 pb-8 md:pb-12 md:flex-row md:items-end">
                        <div className="max-w-xl text-center md:text-left">
                            <h2 className="text-3xl md:text-4xl font-black text-[#12606A]">Success Stories</h2>
                            <p className="mt-2 md:mt-4 text-sm md:text-base text-slate-500">Discover the professional paths of our graduates.</p>
                        </div>
            ...
            {/* Stats Section - Responsive Grid & Font */}
